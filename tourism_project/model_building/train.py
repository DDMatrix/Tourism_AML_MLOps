...
sample_weights = np.array([class_weights_dict[y] for y in ytrain])
...
with mlflow.start_run():
    ...
    # Hyperparameter tuning using sample weights
    grid_search = GridSearchCV(model, param_grid, cv=3, n_jobs=-1)
    grid_search.fit(Xtrain, ytrain, **{"sample_weight": sample_weights})
